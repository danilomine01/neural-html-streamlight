...
st.title('Prediccion de demada')
st.write('datos del huila')

# Importing Training Set
dataset_train = pd.read_excel('HLAD_ORLIST.xlsx')
dataset_train

st.line_chart(dataset_train)


#######################
st.write('Parametros tomados para el calculo')
#######################
...
st.write('Training set shape = {}'.format(dataset_train.shape))
st.write('All timestamps = {}'.format(len(datelist_train)))
st.write('Featured selected: {}'.format(cols))
...
st.write('Shape of training set == {}.'.format(training_set.shape))
training_set
