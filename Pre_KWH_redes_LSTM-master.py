...
#
dataset = pd.read_excel('HLAD_ORLIST1.xlsx',index_col='Fecha', parse_dates=['Fecha'])
dataset.head()

#dataset['2019-12-26 00:00:00':].plot(figsize=(10,5))

set_entrenamiento = dataset['2019-10-30 23:00:00':'2019-11-30 23:00:00'].iloc[:,0:1]
set_validacion = dataset['2019-11-30 23:00:00':].iloc[:,0:1]
